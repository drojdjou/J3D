 ...
 *
 * @param jsanim The JSON animation file
 */
J3D.Loader.parseJSONScene = function(engine, jscene, jmeshes, jsanim) {
...
J3D.Loader.quatFromArray = function(arr) {
    return quat4.normalize(quat4.createFrom(arr[0], arr[1], arr[2], arr[3]));
}
