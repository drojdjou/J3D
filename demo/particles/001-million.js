registerDemo(function(engine) {
    ...
    document.title = "Million particles in a Cube | J3D | v0.12";

    var numParticles = 1000000;

    this.setup = function(callback) {
        J3D.Loader.loadGLSL("particles/001-million.glsl", function(s) {
            onShader(s);
            callback.call(null);
        });
    }
    ...
    function onShader(s) {
        ...
        stars.geometry.addArray("aVertexPosition", J3D.ParticleUtil.insideCube(numParticles, 100), 3);
        // stars.geometry.addArray("aVertexPosition", J3D.ParticleUtil.onSphere(numParticles, 10, 50), 3);
